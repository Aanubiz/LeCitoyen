...
public class FavorisCodePenale extends AppCompatActivity implements ClickListener, AdapterFavorisCodeDeProcedurePenale.ClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_favoris_code_penale);
		...
		dbHandler = new DBSQLiteHandlerCP(getApplicationContext());
