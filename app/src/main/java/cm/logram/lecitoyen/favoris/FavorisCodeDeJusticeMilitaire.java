...
import cm.logram.lecitoyen.sqlite.DBSQLiteHandler;

public class FavorisCodeDeJusticeMilitaire extends AppCompatActivity implements ClickListener, AdapterFavorisCodeJusticeMilitaire.ClickListener {

	Toolbar toolbar;
	public List<Data> wordsListFavourite;
	AdapterFavorisCodeJusticeMilitaire mRecyclerAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_favoris_code_de_justice_militaire);
		...
		if (wordsListFavourite == null) {
		  textView.setVisibility(View.VISIBLE);
			...
			if (wordsListFavourite != null) {
				mRecyclerAdapter = new AdapterFavorisCodeJusticeMilitaire(getApplicationContext(), wordsListFavourite);
