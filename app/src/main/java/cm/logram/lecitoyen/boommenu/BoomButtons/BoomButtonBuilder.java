...
public abstract class BoomButtonBuilder<T> {
    ...
    Rect imageRect = new Rect(Util.dp2px(25), Util.dp2px(25), Util.dp2px(60), Util.dp2px(60));
    ...
    int textTopMargin = Util.dp2px(1);
    int textWidth = Util.dp2px(100);
    int textHeight = Util.dp2px(30);
