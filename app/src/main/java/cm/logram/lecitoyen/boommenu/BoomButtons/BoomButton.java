...
import cm.logram.lecitoyen.boommenu.BMBShadow;
...
public abstract class BoomButton extends FrameLayout {
    ...
    protected void initAttrs(BoomButtonBuilder builder) {
        ...
        typeface = ResourcesCompat.getFont(context, R.font.basic);
        //typeface = Typeface.createFromAsset(context.getAssets(), "font/basic.ttf");
