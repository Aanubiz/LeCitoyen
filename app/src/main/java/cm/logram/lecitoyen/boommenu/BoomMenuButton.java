...
import cm.logram.lecitoyen.boommenu.Animation.AnimationManager;
import cm.logram.lecitoyen.boommenu.Animation.BoomEnum;
import cm.logram.lecitoyen.boommenu.Animation.Ease;
import cm.logram.lecitoyen.boommenu.Animation.EaseEnum;
import cm.logram.lecitoyen.boommenu.Animation.HideRgbEvaluator;
import cm.logram.lecitoyen.boommenu.Animation.OrderEnum;
import cm.logram.lecitoyen.boommenu.Animation.Rotate3DAnimation;
import cm.logram.lecitoyen.boommenu.Animation.ShareLinesView;
import cm.logram.lecitoyen.boommenu.Animation.ShowRgbEvaluator;
import cm.logram.lecitoyen.boommenu.BoomButtons.BoomButton;
import cm.logram.lecitoyen.boommenu.BoomButtons.BoomButtonBuilder;
import cm.logram.lecitoyen.boommenu.BoomButtons.ButtonPlaceAlignmentEnum;
import cm.logram.lecitoyen.boommenu.BoomButtons.ButtonPlaceEnum;
import cm.logram.lecitoyen.boommenu.BoomButtons.ButtonPlaceManager;
import cm.logram.lecitoyen.boommenu.BoomButtons.HamButton;
import cm.logram.lecitoyen.boommenu.BoomButtons.InnerOnBoomButtonClickListener;
import cm.logram.lecitoyen.boommenu.BoomButtons.SimpleCircleButton;
import cm.logram.lecitoyen.boommenu.BoomButtons.TextInsideCircleButton;
import cm.logram.lecitoyen.boommenu.BoomButtons.TextOutsideCircleButton;
import cm.logram.lecitoyen.boommenu.Piece.BoomPiece;
import cm.logram.lecitoyen.boommenu.Piece.PiecePlaceEnum;
import cm.logram.lecitoyen.boommenu.Piece.PiecePlaceManager;

import static cm.logram.lecitoyen.boommenu.Piece.PiecePlaceEnum.Share;
