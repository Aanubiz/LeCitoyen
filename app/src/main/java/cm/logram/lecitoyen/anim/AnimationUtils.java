package cm.logram.lecitoyen.anim;
...
public class AnimationUtils {
	    ...
	    public static void animate(RecyclerView.ViewHolder holder, boolean goesDown) {
	        ...
	        YoYo.with(Techniques.Landing).duration(1000).playOn(holder.itemView);
...
//	        animatorSet.start();
	    ...
	    /**
	     * Courtesy: Muhammad Faisal Hyder
	     *
	     * @param holder
	     * @param goesDown
	     */
	    public static void myAnimation(RecyclerView.ViewHolder holder, boolean goesDown){
	    	ObjectAnimator objAnimator = ObjectAnimator.ofFloat(holder.itemView, "translationY", goesDown==true ? 150:-150,0);
