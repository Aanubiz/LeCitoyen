...
@SuppressLint("NewApi")
public class AdapterFavorisCodePenale extends RecyclerView.Adapter<AdapterFavorisCodePenale.ItemsViewHolder>{
	...
	public AdapterFavorisCodePenale(Context con, List<Data> wordsList){
	...
	public void setListener(ClickListener clicked){
		AdapterFavorisCodePenale.clickListener = clicked;
	}	
