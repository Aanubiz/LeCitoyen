...
import cm.logram.lecitoyen.sqlite.DBSQLiteHandlerCP;

@SuppressLint("NewApi")
public class AdapterCodePenale extends RecyclerView.Adapter<AdapterCodePenale.ItemsViewHolder>{
  private TextToSpeech textToSpeech;
	private List<Data> wordsList;
	public List<Data> favouriteData = new ArrayList<Data>();
	private Context context;
	static CodePenale clickListener;
	DBSQLiteHandlerCP dbHandler;
  int mPreviousPosition = -1;
  public ArrayList<Data> wordsListDB;
  private String searchString="";

  public AdapterCodePenale(Context context, List<Data> wordsList){
		this.wordsList=wordsList;
		this.context=context;
		this.dbHandler = new DBSQLiteHandlerCP(context);
  ...
  public void updateList(List<Data> list, String newText) {
	...
	public void setListener(CodePenale clicked){
		AdapterCodePenale.clickListener = clicked;
	}	
