...
import cm.logram.lecitoyen.reglesDeDroits.CodeElectoral;
import cm.logram.lecitoyen.sqlite.DBSQLiteHandlerCE;

@SuppressLint("NewApi")
public class AdapterCodeElectoral extends RecyclerView.Adapter<AdapterCodeElectoral.ItemsViewHolder>{
  private TextToSpeech textToSpeech;
	private List<Data> wordsList;
	public List<Data> favouriteData = new ArrayList<Data>();
	private Context context;
	static CodeElectoral clickListener;
	DBSQLiteHandlerCE dbHandler;
  int mPreviousPosition = -1;
  public ArrayList<Data> wordsListDB;
  private String searchString="";

  public AdapterCodeElectoral(Context context, List<Data> wordsList){
		this.wordsList=wordsList;
		this.context=context;
		this.dbHandler = new DBSQLiteHandlerCE(context);
  ...
  public void updateList(List<Data> list, String newText) {
	...
	public void setListener(CodeElectoral clicked){
		AdapterCodeElectoral.clickListener = clicked;
	}	
