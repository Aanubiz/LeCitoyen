...
@SuppressLint("NewApi")
public class AdapterFavorisCodeRelatifAuxArmes extends RecyclerView.Adapter<AdapterFavorisCodeRelatifAuxArmes.ItemsViewHolder>{
	private TextToSpeech textToSpeech;
	private List<Data> wordsList;
	public List<Data> favouriteData = new ArrayList<Data>();
	int mPreviousPosition = -1;
	Context context;
	static FavorisCodeRelatifAuxArmes clickListener;
	DBSQLiteHandlerCRA dbHandler;

	public AdapterFavorisCodeRelatifAuxArmes(Context con, List<Data> wordsList){
	...
	public void setListener(FavorisCodeRelatifAuxArmes clicked){
		AdapterFavorisCodeRelatifAuxArmes.clickListener = clicked;
	}	
