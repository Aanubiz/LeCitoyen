...
@SuppressLint("NewApi")
public class AdapterCodeDeJusticeMilitaire extends RecyclerView.Adapter<AdapterCodeDeJusticeMilitaire.ItemsViewHolder>{
  ...
  public AdapterCodeDeJusticeMilitaire(Context context, List<Data> wordsList){
  ...
  public void updateList(List<Data> list, String newText) {
	...
	public void setListener(ClickListener clicked){
		AdapterCodeDeJusticeMilitaire.clickListener = clicked;
	}	
