...
import cm.logram.lecitoyen.reglesDeDroits.CodeRelatifAuxArmes;
import cm.logram.lecitoyen.sqlite.DBSQLiteHandlerCRA;

@SuppressLint("NewApi")
public class AdapterCodeRelatifAuxArmes extends RecyclerView.Adapter<AdapterCodeRelatifAuxArmes.ItemsViewHolder>{
  private TextToSpeech textToSpeech;
	private List<Data> wordsList;
	public List<Data> favouriteData = new ArrayList<Data>();
	private Context context;
	static CodeRelatifAuxArmes clickListener;
	DBSQLiteHandlerCRA dbHandler;
  int mPreviousPosition = -1;
  public ArrayList<Data> wordsListDB;
  private String searchString="";

  public AdapterCodeRelatifAuxArmes(Context context, List<Data> wordsList){
		this.wordsList=wordsList;
		this.context=context;
		this.dbHandler = new DBSQLiteHandlerCRA(context);
  ...
  @Override
    ...
    String article1 = wordsList.get(1).getDescription();
    if (position==1)
      holder.description.setText(Html.fromHtml(article1));
  ...
  public void updateList(List<Data> list, String newText) {
	...
	public void setListener(CodeRelatifAuxArmes clicked){
		AdapterCodeRelatifAuxArmes.clickListener = clicked;
	}	
