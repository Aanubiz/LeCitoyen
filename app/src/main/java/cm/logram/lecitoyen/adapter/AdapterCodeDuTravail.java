...
import cm.logram.lecitoyen.reglesDeDroits.CodeDuTravail;
import cm.logram.lecitoyen.sqlite.DBSQLiteHandlerCT;

@SuppressLint("NewApi")
public class AdapterCodeDuTravail extends RecyclerView.Adapter<AdapterCodeDuTravail.ItemsViewHolder>{
  private TextToSpeech textToSpeech;
	private List<Data> wordsList;
	public List<Data> favouriteData = new ArrayList<Data>();
	private Context context;
	static CodeDuTravail clickListener;
	DBSQLiteHandlerCT dbHandler;
  int mPreviousPosition = -1;
  public ArrayList<Data> wordsListDB;
  private String searchString="";

  public AdapterCodeDuTravail(Context context, List<Data> wordsList){
  ...
  public void updateList(List<Data> list, String newText) {
	...
	public void setListener(CodeDuTravail clicked){
		AdapterCodeDuTravail.clickListener = clicked;
	}	
