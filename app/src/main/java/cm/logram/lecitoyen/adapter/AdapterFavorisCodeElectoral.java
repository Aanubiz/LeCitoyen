...
@SuppressLint("NewApi")
public class AdapterFavorisCodeElectoral extends RecyclerView.Adapter<AdapterFavorisCodeElectoral.ItemsViewHolder>{
	...
	public AdapterFavorisCodeElectoral(Context con, List<Data> wordsList){
	...
	public void setListener(ClickListener clicked){
		AdapterFavorisCodeElectoral.clickListener = clicked;
	}	
