...
@SuppressLint("NewApi")
public class AdapterFavorisCodeJusticeMilitaire extends RecyclerView.Adapter<AdapterFavorisCodeJusticeMilitaire.ItemsViewHolder>{
	...
	public AdapterFavorisCodeJusticeMilitaire(Context con, List<Data> wordsList){
	...
	public void setListener(ClickListener clicked){
		AdapterFavorisCodeJusticeMilitaire.clickListener = clicked;
	}	
