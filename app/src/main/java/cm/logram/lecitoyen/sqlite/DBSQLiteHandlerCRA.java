...
public class DBSQLiteHandlerCRA extends SQLiteOpenHelper {

	public static final int DATABASE_VERSION = 1;
	public static final String DATABASE_NAME = "cra";
	private static final String TABLE_WORD = "table_cra";
	...
	public DBSQLiteHandlerCRA(Context context) {
