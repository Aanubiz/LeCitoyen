...
public class DBSQLiteHandlerCPP extends SQLiteOpenHelper {

	public static final int DATABASE_VERSION = 1;
	public static final String DATABASE_NAME = "cpp";
	private static final String TABLE_WORD = "table_cpp";
	...
	public DBSQLiteHandlerCPP(Context context) {
