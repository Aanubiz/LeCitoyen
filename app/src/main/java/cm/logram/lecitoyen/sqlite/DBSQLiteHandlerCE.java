...
public class DBSQLiteHandlerCE extends SQLiteOpenHelper {

	public static final int DATABASE_VERSION = 1;
	public static final String DATABASE_NAME = "ce";
	private static final String TABLE_WORD = "table_ce";
	...
	public DBSQLiteHandlerCE(Context context) {
