...
public class DBSQLiteHandlerCP extends SQLiteOpenHelper {

	public static final int DATABASE_VERSION = 1;
	public static final String DATABASE_NAME = "cp";
	private static final String TABLE_WORD = "table_cp";
	...
	public DBSQLiteHandlerCP(Context context) {
